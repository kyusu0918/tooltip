...
2.first.ksからプラグインを呼び出してください。
  [plugin name=tooltip]
3.後述のタグリファレンスを参考にしてツールチップを使用します。
...
2026/01/27  ver1.1.1  speech_bracket_floatを設定の際、後続の文字が左側にずれてしまう不具合を修正
2026/01/28  ver1.2.0  既読テキスト対策のため、CSSでのカラー設定へ変更
2026/09/17  ver1.3.0  バックログ関連のプラグイン競合による不具合を修正